...
* The [discussion forum](https://github.com/ccAPPS/ccAPPS/discussions) is to best place to post any question and ideas.

### **Found something unclear or incorrect in the documentation?**

* A pull request to improve the documentation (even just fixing a typo) is one of the easiest ways to contribute to ccAPPS.

  All [online documentation pages](https://ccAPPS.com/docs/current/) have an "edit on github" link that links to the
  page in [this repository](https://github.com/ccAPPS/ccAPPS/tree/master/doc). It can't be simpler than this...
...
* To get the user interface correctly translated to your language, we rely on
  ...
  [Updating a translation](https://ccAPPS.com/docs/current/developer-guide/translating-the-user-interface.php)
  is and easy and clear process. It's a single file to edit and submit as a pull request.
  It's also an easy way to contribute to ccAPPS.

### **Did you find a bug?**

* **Do not open up a GitHub issue if the bug is a security vulnerability**, and instead to refer to
  our [security policy](https://github.com/ccAPPS/ccAPPS/security/policy).

* **Ensure the bug was not already reported by searching the [Issues](https://github.com/ccAPPS/ccAPPS/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/ccAPPS/ccAPPS/issues/new).
