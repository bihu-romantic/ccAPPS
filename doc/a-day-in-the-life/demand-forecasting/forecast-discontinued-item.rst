...
You'll need to manually override the statistical forecast ccAPPS
...
3) Update the field in the Method column from Automatic to Manual. ccAPPS stops forecasting them automatically.
4) Save your changes.
