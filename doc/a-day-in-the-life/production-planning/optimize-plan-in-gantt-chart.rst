...
ccAPPS's planning algorithm automaticaly generates a production plan. The production
...
Any of the above change will trigger a plan update, ccAPPS will make sure that the plan remains feasible.
