...
ccAPPS provides a list of commands that perform actions on the
...
This option runs the ccAPPS planning engine with the input data from the
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl runplan --constraints=capa,po_lt,mfg_lt --plantype=1 --env=fcst,invplan,balancing,supply

        Deprecated (sum of numbers with capa = 4, lt = 1, mfg_lt = 16, po_lt = 32):
        ccAPPSctl runplan --constraints=5 --plantype=1 --env=fcst,invplan,balancing,supply
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl scheduletasks --schedule=my_task_sequence
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl emailreport [--sender] --recipient --report
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl uploadreport --report=report1,report2,report3
...
* | The name must match the data object they store: eg demand.csv, item.csv, item.xlsx, item.csv.gz
  | This is important for ccAPPS to understand the correct processing order of the files.
...
The following file formats are accepted:
  ...
  * | **CSV**:
    ...
    * | The date format expected by ccAPPS is 'YYYY-MM-DD hh\:mm\:ss' (international style).
...
This action starts or stop the ccAPPS web service which keeps the plan
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl runwebservice

        ccAPPSctl stopwebservice
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl scenario_copy [--force --promote] scenario1 scenario2

        # To create scenario1 from a backup file:
        ccAPPSctl scenario_copy --dumpfile=\path_to_my_file\scenario_backup.dump default scenario1

        # To release scenario scenario1:
        ccAPPSctl scenario_release --database=scenario1
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
         ...
         ccAPPSctl measure_copy source_measure destination_measure
...
Contact ccAPPS support
-----------------------

This task should be used to share your data with the ccAPPS support team.
...
be used by the ccAPPS developers solely for the purpose of analysing issues. The data
...
djangosettings.py. It can be downloaded from the browser and sent to the ccAPPS support team.

For security reasons the command is only available to ccAPPS superusers.
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl empty --models=input.demand,input.operationplan
...
all planning relevant data from Odoo into the ccAPPS database.

See :doc:`/erp-integration/odoo-connector/using-the-connector-in-ccAPPS`
...
the demand history in Odoo into the ccAPPS database using the XML RPC API of Odoo.
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl odoo_pull_so_history
...
publishes part of the plan from ccAPPS into odoo.
...
A number of demo datasets are packaged with ccAPPS. Using this action you can
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl loaddata manufacturing_demo
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl createbuckets --weekstart=1 --format-day="%Y-%m-%d" --format-week="%y W%W" --format-month="%b %y" --format-quarter="%y Q%q" --format-year="%Y"
...
This command will create the PostgreSQl databases for ccAPPS.
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl createdatabase

        # Recreate only a single database
        ccAPPSctl createdatabase --database=scenario3
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl migrate --database=default
        ccAPPSctl migrate --database=scenario1
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl restore database_dump_file
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl createsuperuser new_user_name
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl changepassword user_name
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl generatetoken user_name --expiry=365
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl dbshell --database=default
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl dumpdata --database=scenario1
...
.. tabs::
   ...
   .. tab:: Command line
      ...
      .. code-block:: bash
        ...
        ccAPPSctl createmodel --level=3 --cluster=100 --demand=10
...
4. Generate a constrained ccAPPS plan
5. Confirm new purchase orders from the ccAPPS plan
6. Confirm new production orders from the ccAPPS plan
7. Confirm new distribution orders from the ccAPPS plan
