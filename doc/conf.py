...
# -*- coding: utf-8 -*-
#
# ccAPPS documentation build configuration file, created by
...
# ones.
extensions = ["ccAPPS", "sphinx_tabs.tabs", "sphinx_sitemap", "sphinx_reredirects"]
...
latex_documents = [
    ("index", "ccAPPS.tex", "ccAPPS Documentation", "ccAPPS bv", "manual")
]
...
man_pages = [("index", "ccAPPS", "ccAPPS Documentation", ["ccAPPS bv"], 1)]
