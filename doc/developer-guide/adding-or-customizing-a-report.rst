...
as well as the generic view provided by ccAPPS.
...
Using the ccAPPS generic report
--------------------------------

ccAPPS uses a standard view for displaying data in a list or grid layout,
...
#. | **Map the view as a URL**.
   ...
   ::
      ...
      urlpatterns = patterns('',
       ...
       (r'^myreport/([^/]+)/$', 'ccAPPSdb.common.report.view_report',
