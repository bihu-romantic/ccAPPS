...
#. | **Install the javascript dependencies**:
   | Compiling the ccAPPS and bootstrap styles requires a number of
...
#. | **Design the SASS files**:
   | The styles are defined in the following files. Check out
     ...
     customizing the bootstrap CSS styles.
       ...
       - | *ccAPPSdb/common/static/css/ccAPPS.scss*:
         | Defines the ccAPPS specific CSS styles.

       - | *ccAPPSdb/common/static/css/THEME/theme.scss*:
