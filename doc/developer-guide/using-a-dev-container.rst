...
This is the recommended and fastest way to start developing in ccAPPS.
...
#. Pick up the latest code from the repository:
   ::
     ...
     git clone https://github.com/ccAPPS/ccAPPS.git <project_directory>
...
#. Optional, Build the software
   ...
   In VS Code, with the cmake extension installed, just build the "ccAPPS-main" target.
...
#. Optional, start a DB container.
   ...
   The data is stored in your home folder inside "ccAPPSdata" folder.
...
#. Start ccAPPS server:
   ...
   The "./ccAPPSctl.py runserver" command should now work.
