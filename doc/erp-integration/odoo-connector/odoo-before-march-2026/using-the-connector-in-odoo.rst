...
* | The sales menu has a link to the **ccAPPS forecast editor screen**.
...
* | The inventory menu has a link to the **ccAPPS inventory planning screen**.
  ...
  | Note that this screen is only available in the Enterprise Edition of ccAPPS.
    When using the ccAPPS Community Edition these links will result in a
    page-not-found error message.

* | The manufacturing menu has a link to the **ccAPPS plan editor screen**.
...
* The manufacturing menu also contains a link to the complete ccAPPS
  user interface.

  .. image:: _images/odoo-ccAPPS-link.png
   :alt: ccAPPS link in the manufacturing app
...
* | Because some manufacturing concepts do not exist in odoo, the manufacturing app
  ...
  1. Skills: The concept of skill where a work center can have one or more skill has been
     ...
     to the ccAPPS :doc:`../../model-reference/skills` table, used to define the available skills.

     .. image:: _images/skill.png
      :alt: Skill view in odoo

  2. Work Center Skill: This table is equivalent to the ccAPPS :doc:`../../model-reference/resource-skills` table.
  ...
  3. Work centers. Owner: A new field *owner* has been added to the work centers (equivalent to the ccAPPS :doc:`../../model-reference/resources` owner field). Owner field
  ...
  4. Operations: In the Operations view of Odoo, 4 new fields have been added:
     ...
     This table is the equivalent to the ccAPPS :doc:`../../model-reference/operation-resources` table.
...
Starting from Odoo 17, the connectors also allow the planner to use the ccAPPS quoting
module from Odoo.

To activate this functionality for an Odoo user, this user needs to be part of the *ccAPPS quoting user*
group.

.. image:: _images/ccAPPS-quoting-user.png
    :alt: ccAPPS quoting user group

| Note that the quoting capabilities are only available in the Enterprise Edition of ccAPPS.
  When using the ccAPPS Community Edition these links will result in a
  page-not-found error message.
...
* | The quoting capabilities brought by the connectors offer 2 distinct possibilities:
  ...
  2. Addtion of a *ccAPPS Quotes* view accesible with a menu.

     .. image:: _images/ccAPPS-quotes-menuitem.png
        :alt: An additional menu for the ccAPPS quotes

     The *ccAPPS Quotes* screen allows the planner to get in a matter of seconds a promised date for
     a product.
     ...
     From the main screen of the *ccAPPS Quotes*, a *bulk quote* action is also available to allow the planner
