...
* | The menu bar in the sales, purchase, inventory and manufacturing apps
    get 1) a link to open the ccAPPS user interface and 2) a link
...
* | A new table has been added to Odoo with **ccAPPS recommendations** on your plan.

  | The ccAPPS recommendations represent a list of actionable activities relevant for the
  ...
  * | Manufacturing orders to be rescheduled to a new date.
    | When accepting the recommendation, the scheduled start of the manufacturing order and its
      work orders are updated to the start date computed by ccAPPS.
...
* | Because some manufacturing concepts do not exist in odoo, the manufacturing app
  ...
  2. | **Work Center Skill**
     | This table is equivalent to the ccAPPS :doc:`../../model-reference/resource-skills` table.
  ...
  3. | **Work centers**
     ...
     | The constrained flag specifies whether ccAPPS should plan this workcenter with infinite
       capacity or not.
