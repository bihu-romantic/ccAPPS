...
ccAPPS provides 2 constructs to model such alternatives:
...
`Check this feature on a live example <https://demo.ccAPPS.com/alternate-materials/data/input/operationmaterial/>`_
...
* | **Alternate operations**
  ...
  | The `operation table <https://demo.ccAPPS.com/alternate-materials/data/input/operation/>`_ 
  ...
  | The generated plan has 
    `manufacturing orders <https://demo.ccAPPS.com/alternate-materials/data/input/manufacturingorder/>`_ 
    on both operations.
...
* | **Alternate item**
  ...
  | The 
    `operation material table <https://demo.ccAPPS.com/alternate-materials/data/input/operationmaterial/>`_
  ...
  | In the `inventory detail report <https://demo.ccAPPS.com/alternate-materials/data/input/operationplanmaterial/>`_ 
