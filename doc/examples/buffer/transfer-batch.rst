...
`Check this feature on a live example <https://demo.ccAPPS.com/transfer-batch/planningboard/>`_
...
- Set the type of the `Operation Materials <https://demo.ccAPPS.com/transfer-batch/data/input/operationmaterial/>`_ records to "Batch transfer" :samp:`1`.

- Populate the field "transfer batch quantity" in the `Operation Materials <https://demo.ccAPPS.com/transfer-batch/data/input/operationmaterial/>`_ table :samp:`2`. This defines
