...
`Check this feature on a live example <https://demo.ccAPPS.com/calendar-working-hours/data/input/location/>`_
...
* | The attached example models a warehouse where the manufacturing operations are running on 
  ...
  | You can review this setup in the 
    `location table <https://demo.ccAPPS.com/calendar-working-hours/data/input/location/>`_,
    `calendar table <https://demo.ccAPPS.com/calendar-working-hours/data/input/calendar/>`_,
    `calendar bucket table <https://demo.ccAPPS.com/calendar-working-hours/data/input/calendarbucket/>`_
...
* | The results can be review from the 
    `manufacturing order <https://demo.ccAPPS.com/calendar-working-hours/data/input/manufacturingorder/>`_.
    and `distribution order <https://demo.ccAPPS.com/calendar-working-hours/data/input/distributionorder/>`_.
