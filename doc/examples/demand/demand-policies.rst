...
* **Maximum lateness** :samp:`B`.
  ...
  When the demand isn’t feasible within this delay ccAPPS will plan the order short.
...
`Check this feature on a live example <https://demo.ccAPPS.com/demand-policies/>`_
