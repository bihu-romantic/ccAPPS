...
ccAPPS's planning algorithm processes demand per demand. One by one, each demands gets planned and reserves the stock, raw materials and capacity it needs.
...
ccAPPS orders the demands based on the following attributes:
...
`Check this feature on a live example <https://demo.ccAPPS.com/demand-priorities/data/input/manufacturingorder/>`_
