...
ccAPPS implements 5 times series methods to compute the statistical forecast.

`Check this feature on a live example <https://demo.ccAPPS.com/forecast-method/data/forecast/forecast/>`_
...
4. | **Seasonal**:
   ...
   | ccAPPS automatically detects for the periodicity of the recurring patterns.
...
6. | **Automatic** (default):
   | This is the default forecast method. ccAPPS will evaluate all 5 statistical forecast
     methods described above and will pick the one that minimizes the forecast error.

7. | **Manual**:
   | This option prevents ccAPPS from computing any forecast. The forecast will be
...
* | The
    `forecast table <https://demo.ccAPPS.com/forecast-method/data/forecast/forecast/>`_
  ...
  | By default, this table is automatically populated based on the intersections 
    ...
    `parameter forecast.populateForecastTable <https://demo.ccAPPS.com/forecast-method/data/common/parameter/?name=forecast.populateForecastTable>`_
    for more details).
...
* The forecasts are best navigated with the 
  `forecast report <https://demo.ccAPPS.com/forecast-method/forecast/>`_
  or the `forecast editor <https://demo.ccAPPS.com/forecast-method/forecast/editor/>`_
