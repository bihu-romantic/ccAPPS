...
`Check this feature on a live example <https://demo.ccAPPS.com/forecast-netting/forecast/?mode=table>`_
...
ccAPPS allows the sales orders to consume from future or past buckets.
...
2. | Then the netting process will net the sales from February 2019. 
   ...
   | Because there is more sales orders than gross forecast for that month, ccAPPS
...
3. | Finally the netting process will net the sales from March 2019. ccAPPS will
