...
`Check this feature on a live example <https://demo.ccAPPS.com/middle-out-forecast/forecast/editor/>`_
...
* | **Bottom-up forecasting**
  ...
  | The
    `forecast report <https://demo.ccAPPS.com/middle-out-forecast/forecast/?location__name__contains=bottom>`__
    and the
    `forecast editor <https://demo.ccAPPS.com/middle-out-forecast/forecast/editor/>`__
...
* | **Middle-out forecasting**
  ...
  | The
    `forecast report <https://demo.ccAPPS.com/middle-out-forecast/forecast/?location__name__contains=middle>`__
    and the
    `forecast editor <https://demo.ccAPPS.com/middle-out-forecast/forecast/editor/>`__
    are good screens to review the results.
...
* | To configure the forecasting level, you need to populate the
    `forecast table <https://demo.ccAPPS.com/middle-out-forecast/data/forecast/forecast/>`__
    table correctly.
