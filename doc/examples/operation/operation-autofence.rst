...
purchase order coming in on day 10. Do you want that ccAPPS can propose a new
...
after 40 days. Do you want that ccAPPS can propose a new purchase order
earlier than day 40?  Probably yes.

`Check this feature on a live example <https://demo.ccAPPS.com/operation-autofence/>`_
...
* | This example shows two items. Each of these items can be manufactured
    ...
    `operation table <https://demo.ccAPPS.com/operation-autofence/data/input/operation/>`_.
    The outsourcing is defined in the
    `item supplier table <https://demo.ccAPPS.com/operation-autofence/data/input/itemsupplier/>`_.
  ...
  | Each item has a single
    `sales order <https://demo.ccAPPS.com/operation-autofence/data/input/demand/>`_.

  | We have confirmed
    `purchases orders <https://demo.ccAPPS.com/operation-autofence/data/input/purchaseorder/>`_
    with the subcontractor going as far out as 30 days.

* | The release fence can be set differently on each
    `operation <https://demo.ccAPPS.com/operation-autofence/data/input/operation/>`_.

  .. image:: _images/operation-autofence-1.png
     :alt: Operation table

* | With the
    `parameter plan.autoFenceOperations <https://demo.ccAPPS.com/operation-autofence/data/common/parameter/>`_
...
* | For item "widget B", ccAPPS chooses to wait for the incoming shipment
...
* | For the item "widget A" the supply arrives much later, and ccAPPS proposes to
