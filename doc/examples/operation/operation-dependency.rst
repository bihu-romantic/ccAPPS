...
This example model illustrates how ccAPPS can be applied to a project-oriented business.
...
`Check this feature on a live example <https://demo.ccAPPS.com/operation-dependency/data/input/operationdependency/>`_
