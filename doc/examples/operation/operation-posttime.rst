...
In ccAPPS you can define a time gap after the operation has finished. This time
...
`Check this feature on a live example <https://demo.ccAPPS.com/operation-posttime/data/input/operation/>`_
...
* | In this example we model a two-step production process with a decoupling buffer
  ...
  | Check out the
    `supply path <https://demo.ccAPPS.com/operation-posttime/supplypath/demand/Demand%201/>`_
...
* | The first demand is overdue. When you review 
    `its delivery plan <https://demo.ccAPPS.com/operation-posttime/demandpegging/Demand%201/>`_,
...
* | The 
    `second demand <https://demo.ccAPPS.com/operation-posttime/demandpegging/Demand%202/>`_
...
* | The next demands,
    `"Demand 03" <https://demo.ccAPPS.com/operation-posttime/demandpegging/Demand%203/>`_
    and `"Demand 04" <https://demo.ccAPPS.com/operation-posttime/demandpegging/Demand%204/>`_,
