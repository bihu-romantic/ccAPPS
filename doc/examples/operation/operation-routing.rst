...
It is possible in ccAPPS to declare an operation of type routing.
...
`Check this feature on a live example <https://demo.ccAPPS.com/operation-routing/data/input/operation/>`_

:download:`Download an Excel spreadsheet with the data for this example<operation-routing.xlsx>`

Looking at the `Manufacturing Orders <https://demo.ccAPPS.com/operation-routing/data/input/manufacturingorder/>`_ table, 
