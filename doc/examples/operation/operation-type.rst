...
When creating operations in ccAPPS, different operation types are available and should be 
...
* **Split**
  ...
  | This operation type plans the demand proportionally over a number of operations, based
    ...
    *Priority* column :samp:`B`. There is no need that the percentages sum up to 100, ccAPPS
...
* **Alternate**
  ...
  | In the majority of models you don't have to explicitly use alternate operations 
    in your model. ccAPPS will automatically create them as soon as there are multiple
...
`Check this feature on a live example <https://demo.ccAPPS.com/operation-type/data/input/operation/>`_
