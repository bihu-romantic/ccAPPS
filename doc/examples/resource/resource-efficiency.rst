...
`Check this feature on a live example <https://demo.ccAPPS.com/resource-efficiency/data/input/resource/>`_
...
When executing a constrained supply planning, ccAPPS will create 2 manufacturing orders
...
`Resource Detail <https://demo.ccAPPS.com/resource-efficiency/data/input/operationplanresource/>`_ report:
