...
`Check this feature on a live example <https://demo.ccAPPS.com/resource-skills/data/input/resource/>`_
...
* This example models a simple job shop. It has a number of machining tools and
  ...
  `resource <https://demo.ccAPPS.com/resource-skills/data/input/resource/>`_,
  `skill <https://demo.ccAPPS.com/resource-skills/data/input/skill/>`_ and 
  `resource-skill <https://demo.ccAPPS.com/resource-skills/data/input/resource-skill/>`_ 
  tables.
...
* | The `resource detail report <https://demo.ccAPPS.com/resource-skills/data/input/operationplanresource/>`_
