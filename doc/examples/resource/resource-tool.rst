...
ccAPPS has 3 constructs to model different types of tools.
...
`Check this feature on a live example <https://demo.ccAPPS.com/resource-tool/data/input/operationmaterial/>`_
...
* | They are modeled as a buffer for which the subcategory field is set
  ...
  | The operation that claims the tool gets an
    `operation-material <https://demo.ccAPPS.com/resource-tool/data/input/operationmaterial/>`_
...
* | Use the
    `manufacturing order report <https://demo.ccAPPS.com/resource-tool/data/input/manufacturingorder/>`_
...
* | You can change the initial inventory of the kanban cards
    in the `buffer table <https://demo.ccAPPS.com/resource-tool/data/input/buffer/>`_
...
* The tool resources are marked with the subcategory "tool" (when independent of the MO quantity)
  ...
  in the `resource table <https://demo.ccAPPS.com/resource-tool/data/input/resource/>`_.
