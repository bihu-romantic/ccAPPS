...
ccAPPS has different resource types that represent these different views on
...
`Check this feature on a live example <https://demo.ccAPPS.com/resource-type/data/input/resource/>`_
