...
`Check this feature on a live example <https://demo.ccAPPS.com/supplier-capacity/data/input/itemsupplier/>`_
...
* | We have a single supplier that can ship us 100 parts per week. We need to buy
  ...
  | You can review this setup in the 
    `item supplier table <https://demo.ccAPPS.com/supplier-capacity/data/input/itemsupplier/>`_
    which associates a resource with the purchasing. The 
    `resource table <https://demo.ccAPPS.com/supplier-capacity/data/input/resource/>`_
    associates a capacity calendar, which can be reviewed in detail in the  
    `calendar bucket table <https://demo.ccAPPS.com/supplier-capacity/data/input/calendarbucket/>`_.
...
* | The supplier is also shutting down for summer holidays during July.
  ...
  | This can be reviewed in the 
    `location table <https://demo.ccAPPS.com/supplier-capacity/data/input/location/>`_
...
* | The resulting plan can be reviewed from 
    `purchase order report <https://demo.ccAPPS.com/supplier-capacity/data/input/purchaseorder/>`_
    and the
    `resource report <https://demo.ccAPPS.com/supplier-capacity/resource/>`_.
