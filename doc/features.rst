...
| hierarchical review**                   | customer, and time hierarchies.                                            | - `Live demo <https://demo.ccAPPS.com/Distribution/forecast/editor/>`__      |
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
...
|                                         | and time hierarchies. The values are automatically distributed to lower    | - `Live demo <https://demo.ccAPPS.com/Distribution/forecast/editor/>`__      |
...
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| **Capacity planning**                   | ccAPPS's capacity plan provides a timely visibility of upcoming capacity  | - Doc :doc:`user-interface/plan-analysis/resource-report` screen              |
...
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| **Production scheduling**               | Use ccAPPS to generate detailed short-term production schedules. You can  | - Doc :doc:`user-interface/plan-analysis/plan-editor`                         |
|                                         | then visualize your plan in an interactive Gantt chart and make final      | - `Live demo <https://demo.ccAPPS.com/planningboard/>`__                     |
|                                         | adjustments.                                                               | - Video                                                                       |
...
|                                         |                                                                            |                                                                               |
|                                         | ccAPPS generates plans that will follow the pace of the bottleneck:       |                                                                               |
|                                         |                                                                            |                                                                               |
...
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| **DDMRP (Demand Driven MRP)**           | ccAPPS aligns well with the principles of DDMRP and implements the base   |                                                                               |
|                                         | concepts.                                                                  |                                                                               |
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
...
|                                         | order ASAP.                                                                |                                                                               |
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| **Constrained and                       | ccAPPS can generate different plan types:                                 |  - `Plan generation <command-reference.html#runplan>`_                        |
...
|                                         |   shortages.                                                               |                                                                               |
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| **Fast heuristic solver                 | ccAPPS uses a heuristic planning algorithm, that can provide constrained  | - Doc :doc:`developer-guide/planning-algorithm`                               |
...
|                                         | The ccAPPS connector is an Odoo addon that synchronizes all planning      |                                                                               |
|                                         | to ccAPPS.                                                                |                                                                               |
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
...
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| **Integrated user interface**           | The ccAPPS user interface is integrated in odoo. Users log in Odoo and    | - `Live demo Odoo 17 <https://odoo17.ccAPPS.com/>`__                         |
|                                         | can navigate from Odoo to all ccAPPS screens.                             | - `Live demo Odoo 18 <https://odoo18.ccAPPS.com/>`__                         |
|                                         |                                                                            | - `Live demo Odoo 19 <https://odoo19.ccAPPS.com/>`__                         |
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
...
|                                         |                                                                            |                                                                               |
|                                         | ccAPPS can plan these and automatically make a smart selection between    |                                                                               |
...
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| **Date effective bill of materials and  | ccAPPS can suggest different versions of the bill of material with        | - Doc :doc:`model-reference/operation-materials`                              |
...
|                                         |                                                                            |                                                                               |
|                                         | ccAPPS supports Chrome, Firefox, Edge, Safari and other modern            |                                                                               |
|                                         | web browsers.                                                              |                                                                               |
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| **Multi-lingual**                       | Available in English, French, German, Hebrew, Italian, Japanese, Dutch,    | - `Live demo <https://demo.ccAPPS.com/preferences/>`__                       |
...
| Feature                                 | Description                                                                | Read more                                                                     |
+=========================================+============================================================================+===============================================================================+
| **Integrated data maintenance**         | Data that is not maintained in external systems can be managed in ccAPPS. | - Doc :doc:`user-interface/data-maintenance`                                  |
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
...
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| **REST API**                            | A web-based JSON-REST API allows ccAPPS to be integrated online with      | - `Live demo <https://demo.ccAPPS.com/api/>`__                               |
|                                         | other applications.                                                        |                                                                               |
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
...
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| **On-site deployment**                  | For security or policy reasons, you can install ccAPPS on your own        |                                                                               |
|                                         | servers.                                                                   |                                                                               |
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
...
+-----------------------------------------+----------------------------------------------------------------------------+-------------------------------------------------------------------------------+
| **Pricing is based on                   | Check out the `price calculator <https://ccAPPS.com/pricing>`_            |                                                                               |
