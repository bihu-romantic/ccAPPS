...
the command line with the ccAPPSctl utility.

Usage::

   ccAPPSctl subcommand [options] [args]

Type 'ccAPPSctl.py help <subcommand>' for help on a specific subcommand.
...
framework used by ccAPPS. More details on the commands can be found on
