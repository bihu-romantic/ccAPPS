...
ccAPPS can import CSV-formatted files from a configurable data directory.
And ccAPPS can export its planning results in a set of CSV-formatted files as well.
...
* You can run the task from the command line using the 
  :doc:`ccAPPSctl utility</integration-guide/batch-commands>`.
