...
ccAPPS supports 3 methods for authentication of your user:
...
HTTPS encryption of the web traffic to the ccAPPS server is essential in each
...
new data in the ccAPPS database and generate a new plan.

* Delete previous data files.

* Upload data files (in csv or excel format).

* Import the data files into ccAPPS.
