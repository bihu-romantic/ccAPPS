...
This table contains the manufacturing orders of your supply chain, either proposed by ccAPPS or confirmed.

This table is populated with new proposed manufacturing orders when ccAPPS generates a plan.
...
reference          string            | Unique identifier for the manufacturing order.
                                     ...
                                     | For manufacturing orders newly proposed by ccAPPS, a unique numeric identifier will automatically be generated.
...
status             non-empty string  This field should have one of the following values:
                                     ...
                                     * | proposed:
                                       | The manufacturing order is proposed by ccAPPS to meet the plan (optimization output).

                                     * | approved:
                                       | The manufacturing order is present in the ERP system but can still be rescheduled by ccAPPS (optimization input).
                                     ...
                                     * | confirmed:
                                       ...
                                       | It can not be changed by ccAPPS, even if it violates the lead time, material or capacity 
...
demand             demand            | The field marks this manufacturing order as the shipment delivery
                                       of a demand.
                                     | This is only needed in very exceptional use case. 99% of ccAPPS configurations
