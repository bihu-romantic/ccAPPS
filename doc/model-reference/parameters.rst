...
plan.administrativeLeadtime          | Specifies an administrative lead time in days.
                                     | ccAPPS will plan the sales orders this amount of time ahead of their
...
plan.fixBrokenSupplyPath             | When set to true (which is the default), ccAPPS will scan for
                                       items that can't be replenished any longer with purchase orders,
                                       distribution orders or manufacturing orders.

                                     | ccAPPS automatically creates a dummy/fake supplier for such items.
...
ccAPPS keeps a history of the key metrics of your plan. These metrics are used to display overall trends in your plan, and can
