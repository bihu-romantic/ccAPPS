...
suppliers), either proposed by ccAPPS or confirmed.

This table is populated with new proposed purchase orders when ccAPPS generates a plan.
...
reference        string            | Unique identifier for the purchase order.
                                   ...
                                   | For purchase orders newly proposed by ccAPPS, a unique numeric identifier will automatically be generated.
...
status           string            This field should have one of the following keywords:
                                   ...
                                   * | proposed:
                                     | The purchase order is proposed by ccAPPS to meet the plan (optimization output).

                                   * | approved:
                                     | The purchase order is present in the ERP system but can still be rescheduled by ccAPPS (optimization input).
