...
This table contains the work orders of your supply chain, either proposed by ccAPPS or confirmed.

This table is populated with new proposed work orders when ccAPPS generates a plan.
...
reference          string            | Unique identifier for the work order.
                                     ...
                                     | For work orders newly proposed by ccAPPS, a unique numeric identifier will automatically be generated.
...
status             non-empty string  This field should have one of the following values:
                                     ...
                                     * | proposed:
                                       | The work order is proposed by ccAPPS to meet the plan (optimization output).

                                     * | approved:
                                       | The work order is present in the ERP system but can still be rescheduled by ccAPPS (optimization input).
