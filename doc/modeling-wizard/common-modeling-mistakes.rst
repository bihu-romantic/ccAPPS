...
To generate a valid plan ccAPPS needs the complete replenishment chain for all buffers
...
Correction:
  ...
  | This problem is caused by the fact that ccAPPS doesn't allow a manufacturing
  ...
  | Note that ccAPPS does allow a manufacturing order to be planned over a period
