...
When generating a plan ccAPPS will add new proposed distribution orders to this table.

For a first simplified model, this table can be left empty, ccAPPS will generate proposed distribution orders to meet the plan. 
