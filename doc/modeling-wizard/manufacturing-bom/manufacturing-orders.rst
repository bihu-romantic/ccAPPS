...
When generating a plan ccAPPS will add new proposed manufacturing orders to this table.

For a first simplified model, this table can be left empty, ccAPPS will generate proposed manufacturing orders to meet the plan.
