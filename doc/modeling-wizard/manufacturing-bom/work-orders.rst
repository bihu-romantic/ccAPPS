...
When generating a plan ccAPPS will add new proposed work orders to this table.

For a first simplified model, this table can be left empty, ccAPPS will generate proposed work orders to meet the plan.
