...
By default, ccAPPS will create for an operation as many work orders as needed to 
...
identical machines, then you can model only one operation in ccAPPS and use a 
