...
When generating a plan ccAPPS will add new proposed purchase orders to this table.

For a first simplified model, this table can be left empty, ccAPPS will generate proposed purchase orders to meet the plan.
