...
ccAPPS has a modular architecture. There are a number of core modules,
and also a number of optional apps that provide new functionality.

Extensions can be provided by the ccAPPS team,
`the ccAPPS user community <https://github.com/ccAPPS/ccAPPS/discussions/>`_
